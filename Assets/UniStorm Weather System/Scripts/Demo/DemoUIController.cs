...
namespace UniStorm.Example
{
    public class DemoUIController : MonoBehaviour
    {
...
#if ENABLE_INPUT_SYSTEM
            // Initialize the escape key action for the new input system
        ...
        {
            // Call UniStorm's Manager to update the cloud quality by passing the dropdown value and converting it.
        ...
        {
            // Call UniStorm's Manager to update the cloud type by passing the dropdown value and converting it.
